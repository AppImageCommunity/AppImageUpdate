...
# bundle applications
./linuxdeployqt-continuous-x86_64.AppImage -verbose=3 AppDir/usr/share/applications/appimageupdatetool.desktop -bundle-non-qt-libs -executable AppImageUpdate -executable AppImageSelfUpdate
